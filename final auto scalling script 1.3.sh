        ...
        then 
            ...
            then                
                ...
                do
                    ...
                    if (( var >= 60 )) #condition to scall down a value (var==cpu_value)
                    then
                        check=1
                    else
                        check=0
        ...
        then 
            ...
            then                
                ...
                do
                    ...
                    #it will check the value of cpu of all the replicas of a pods if the values of all the pods is less then 20
                    if (( var <= 30 )) #condition to scall down a value (var==cpu_value)
                    then
                        echo "var: " $var
